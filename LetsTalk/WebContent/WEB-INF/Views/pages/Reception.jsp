...
<head>
<meta charset="utf-8">
 <title>Let's Talk - Reception </title>
<link rel="stylesheet" type="text/css" href="./Ressources/bootstrap/css/bootstrap.css" />
<link rel="stylesheet" type="text/css" href="./Ressources/CSS/reception.css" />
<link rel="shortcut icon" type="image/x-icon" href="./Ressources/image/ic.png" />
<script type="text/javascript" src="./Ressources/JS/reception.js"> </script>
...
<body>
	<div class="container-fluid">
	  ...
	  <div class="content row">
	    <%@include file="../contents/ContentReception.jsp" %>
	  </div>
